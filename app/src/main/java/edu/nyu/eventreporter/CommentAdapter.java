...
import edu.nyu.eventreporter.entity.Comment;
...
public class CommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class CommentViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView commenterIcon;
        public View layout;
...
//            commenterIcon = (ImageView) v.findViewById(R.id.commenter_icon);
        }
    }
    ...
    private void setLike (final DataSnapshot eventSnapshot, final CommentAdapter.EventViewHolder holder, final int number, final Event event) {
